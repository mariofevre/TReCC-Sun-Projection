...
Name: 'Fiat Lux - environment version'
Blender: 2.49b
Group: 'Wizards'
Tooltip: 'sun position calculator on any point on earth'
"""

__versionauthor__ = 'TReCC'
__version__ = '1.0'
__versionurl__ = ["Author's site , http://www.trecc.com.ar"]
__versionemail__=["mario@trecc.com.ar"]


__originalauthor__ = 'GNUdo'
__originalurl__ = ["Author's site , http://www.netlabor.it"]
__originalemail__=["francesco@netlabor.it"]
...
####### BEGIN GPL LICENSE ################################################
# Copyright (C) 2008  Francesco Proietti
#
...
# V. 1.0 - 12-09-2010 - environment functions been added - by: TReCC
#           
##########################################################################################
...
def drawParams():
	...
	# Mode
	BGL.glColor3f(1, 1, 1)
	BGL.glRasterPos2d(15, y-375)
	Draw.Text("Mode")
	# Singlesun button
	Singlesun = Draw.Toggle("Single Sun", 103, 15, y-400, 80, 20, Singlesun.val, "enter single sun mode")
	# Anim button
	Anim = Draw.Toggle("Animation", 103, 103, y-400, 80, 20, Anim.val, "enter animation mode")
	# Environmetn button
	Environment = Draw.Toggle("Environment", 103, 191, y-400, 80, 20, Environment.val, "enter environment analisis mode")
...
def gui():
	...
	if Info.val == 0 and SunData.val == 0 and Anim.val == 0:
		drawLoc()
		drawParams()
		drawCreate()
	elif Info.val == 0 and SunData.val == 0 and Anim.val == 1:
